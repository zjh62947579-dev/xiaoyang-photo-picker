...
本项目是基于开源项目 **片刻 (Pianke)** 的本地包装版本，保留原项目的许可证、版权声明和作者联系方式。原项目地址：[github.com/zhaoyue4810/pianke](https://github.com/zhaoyue4810/pianke)。

---

## 📣 关于授权与来源（请在使用前阅读）

> **小羊帮你筛照片基于片刻改造；片刻项目完全免费，不收一分钱。**
>
